...
(Alternatively, you can open the project named "Problem Set 2" on Posit.cloud and complete the assignment in your browser without needing to install anything. If you don't have access to the class Posit.cloud account, *please let me know as soon as possible*. [This link should take you to the project](https://posit.cloud/spaces/462899/content/7314592)—if it doesn't, log in and look for the project named "Problem Set 2.")
