...
**I've created a Quarto template you can use here:** [{{< fa file-archive >}} `measurement.zip`](/projects/measurement.zip). It's also [available on Posit.cloud](https://posit.cloud/spaces/462899/content/7314608).
