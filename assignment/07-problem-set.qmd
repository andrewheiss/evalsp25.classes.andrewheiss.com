...
1. If you're using R on your own computer, download this file, [*unzip it*](/resource/unzipping.qmd), and double click on the file named `problem-set-7.Rproj`: [{{< fa file-archive >}} `problem-set-7.zip`](/projects/problem-set-7.zip)
   ...
   (Alternatively, you can open the project named "Problem Set 7" on Posit.cloud and complete the assignment in your browser without needing to install anything. [This link should take you to the project](https://posit.cloud/spaces/599025/content/9520194)—if it doesn't, log in and look for the project named "Problem Set 7.")
