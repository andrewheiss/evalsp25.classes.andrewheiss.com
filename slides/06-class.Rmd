---
title: "Class 6: DAGs and threats to validity"
author: "Andrew Heiss"
date: "`r Sys.Date()`"
output:
...
.box-3.large[DAGs are a *statistical* tool]

.box-inv-3[Describe a data-generating process<br>and isolate/identify relationships]

--

.box-3.large.sp-before[Logic models are a *managerial* tool]

.box-inv-3[Oversee the inner workings of a program and its theory]
...
.center.small[[The opera!](https://evalsp25.classes.andrewheiss.com/slides/01-slides.html#81)]
